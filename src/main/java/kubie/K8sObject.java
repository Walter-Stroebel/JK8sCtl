...
public class K8sObject implements Metadata {
    ...
    public FoundLeaf traverse(Traverser tr) {
        return traverse(new K8sPath(getNamespace(), getKind(), getName()), tr);
    }
    ...
    public DefaultMutableTreeNode getTree() {
        ...
        if (getKind().equals("namespace")) {
            TreeMap<String, DefaultMutableTreeNode> byKind = new TreeMap<>();
            ...
            for (Map.Entry<String, DefaultMutableTreeNode> e:byKind.entrySet()){
                ret.add(e.getValue());
            }
        }
        return ret;
    ...
    public TreeMap<Integer, K8sRelation> getRelations() {
        ...
        {
            K8sObject ns = Maps.get("namespace", getNamespace());
            if (null != ns) {
